 ...
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2013-3-25 下午7:38:20 $
 */
public abstract class SecurityUtils {
    ...
    public static String encodeBy36Radix(String str) {
        ...
        do {
            ...
            if (isSeven) {
                StringBuilder.append(enoughZero(Long.toString(longval, 36), 11));
            }
            else {
    ...
    public static String getHttpParamsSecuryKey(Map<String, String> httpParamsMap, String md5Key) {
        ...
        str.append(md5Key);
        return encodeByMD5(str.toString());
    }
